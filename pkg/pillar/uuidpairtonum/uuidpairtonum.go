...
// UUIDs to  Number Map Routines
func uuidPairToToNumKey(baseID uuid.UUID, appID uuid.UUID) string {
...
func NumGet(log *base.LogObject, pub pubsub.Publication,
	...
	key := uuidPairToToNumKey(baseID, appID)
...
func NumGetOldestUnused(log *base.LogObject, pub pubsub.Publication,
	baseID uuid.UUID, baseSize int, numType string) (uuid.UUID, int, error) {
